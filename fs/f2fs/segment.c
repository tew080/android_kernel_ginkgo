...
init_thread:
	fcc->f2fs_issue_flush = kthread_run_perf_critical(cpu_perf_mask, issue_flush_thread, sbi,
...
init_thread:
	dcc->f2fs_issue_discard = kthread_run_perf_critical(cpu_perf_mask, issue_discard_thread, sbi,
